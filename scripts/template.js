function generateTypeIcons(types) {
    ...
    return typeIconsHTML; // Gibt den HTML-Code für die Typen-Icons zurück
  }
  
  function generatePokemonCardTemplate(pokemonData, index) {
    const typeIconsHTML = generateTypeIcons(pokemonData.types);
    return `<div class="pokemon-card ${pokemonData.types[0]}" id="pokemon-card-${index}"> 
        ...
        </div> `; // Gibt den HTML-Code für die Pokémon-Karte zurück
  }
